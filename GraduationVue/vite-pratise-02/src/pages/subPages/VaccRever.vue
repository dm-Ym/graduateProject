<template>
  <!-- <div class="h-50px">
    <el-button type="primary" class="mr-10" @click="dialogVisible = true">预约</el-button>
  </div> -->
  <el-table :data="tableData" border stripe class="w-[99%]">
    ...
    <el-table-column label="操作" width="180">
      <template v-slot="scope">
        <el-button type="primary" @click="dialogVisible = true">预约</el-button>
...
<script>
import { getBooking, getListBooking } from '@/api/get';
