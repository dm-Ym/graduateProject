...
public class JWTUtil {
    ...
    //token的密钥
    private static final String SECRET="jwt+shiro+test";


    public static String createToken(ResidentUser residentUser) throws UnsupportedEncodingException {
        //token过期时间
        ...
        String token= JWT.create()
                .withHeader(map)
                .withClaim("username", residentUser.getFullName())//私有声明
